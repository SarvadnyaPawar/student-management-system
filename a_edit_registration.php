...
<form action="a_edit_registration.php" method="POST">
 ...
 <!-- Class Type -->
  ...
  <div class="form-group">
    ...
    <input type="number" name="total_payment" id="total_payment" value="<?php echo $row['total_payment']; ?>">
                </div>
 <div class="form-group">
      <div>
    <div class="form-row">
...
$stmt->bind_param("sssssssssssddddddddssssssi", 
    ...
    header("Location: a_view_registrations.php");
    exit();
}
?>
  </main>  </body>
